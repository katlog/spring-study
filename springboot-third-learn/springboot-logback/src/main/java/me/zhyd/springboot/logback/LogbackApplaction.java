package me.zhyd.springboot.logback;
...
@RestController
public class LogbackApplaction {
    private static final Logger LOGGER = LoggerFactory.getLogger(LogbackApplaction.class);
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication.run(LogbackApplaction.class, args);
    }
